function passwordValidator(password){
  ...
  for (let i = 0; i < passwordLength; i++) {
    ...
    // Counts the number of allowed characters
    if (curElementAsCode > 47 && curElementAsCode < 58 || curElementAsCode > 64 && curElementAsCode < 91 || curElementAsCode > 96 && curElementAsCode < 123){
      numTypeChar ++;
    }
  }
  ...
  if (validationLengthOfPassword === true && validationTwoDigits === true && validationTypeCharacters === true){
    console.log(`Password is valid`);
  }
}

passwordValidator('022ad8qz'); 